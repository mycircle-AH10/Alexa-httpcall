...
function handleGetInfoIntent(intent, session, callback) {
    var spice = this.event.request.intent.slots.grocery.value;
    //var speechOutput = spice

    //console.log(spice);
    this.emit(':ask', spice, 'try again');
    callback(session.attributes, buildSpeechletResponseWithoutCard(spice, "", true))
